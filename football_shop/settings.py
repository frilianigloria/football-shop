...
SECRET_KEY = 'django-insecure--5_l1p-rpxheqy$v1m007c!vp)dx+3w*6*-pikk1du=h*hz@x5'
...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "friliani-gloria-footballshop.pbp.cs.ui.ac.id", "10.0.2.2"]
